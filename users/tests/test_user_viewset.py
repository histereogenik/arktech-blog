...
def test_user_list_unauthenticated():
    ...
    assert response.status_code == 401  # IsAdminUser blocks unauthenticated
...
class TestUserAPI:
    ...
    def test_update_user(self, auth_client, create_user):
    ...
    def test_delete_user(self, auth_client, create_user):
